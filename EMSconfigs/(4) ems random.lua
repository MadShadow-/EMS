...
EMS_CustomMapConfig =
{
	...
	Callback_OnMapStart = function()
		...
		Script.Load( "maps\\externalmap\\rmg.lua" );
	end,
	...
	Callback_OnGameStart = function()
		RandomMapGenerator.InitGenerationData()--RandomMapGenerator.DefaultGeneratorData)
		RandomMapGenerator.FinalizeGenerationData()--RandomMapGenerator.GenerationData)
		RandomMapGenerator.GenerateMap()--RandomMapGenerator.DefaultGeneratorData)
	end,

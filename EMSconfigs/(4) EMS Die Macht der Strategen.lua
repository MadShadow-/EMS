...
--
    if GUI.GetPlayerID() == playerID then
        if playerID == 2 then
           ...
           Message("@color:250,55,50 Ihr habt die Truhe von Spieler 2 gemobst, das bringt schlechtes Karma mit sich!");
        end
    end
end
--
...
--
    if GUI.GetPlayerID() == playerID then
        if playerID == 3 then
           ...
           Message("@color:250,55,50 Ihr habt die Truhe von Spieler 3 gemobst, das bringt schlechtes Karma mit sich!");
        end
    end
end
--

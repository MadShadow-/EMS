...
EMS_CustomMapConfig =
{
	...
	Callback_OnMapStart = function()
		...
		--FolderVersion:
		--local gvBasePath = "maps\\user\\"..Framework.GetCurrentMapName().."\\";
		...
		Logic.SetPlayerRawName(5, "Eastshire")
		Logic.SetPlayerRawName(6, "Westshire")
		Logic.SetPlayerRawName(7, "Banditen")
		Logic.SetPlayerRawName(8, "Landvolk")
...
--------- Kimichuras Farben-KI-Verwalter--------------------------------
		...
		Display.SetPlayerColorMapping(5, colors[7])
		Display.SetPlayerColorMapping(6, colors[16])
		Display.SetPlayerColorMapping(7, colors[3])
